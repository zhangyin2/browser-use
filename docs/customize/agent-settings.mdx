...
`browser_context`: A Playwright browser context. Useful for maintaining persistent sessions. See <a href="/customize/real-browser">Persistent Browser</a> for more details.
