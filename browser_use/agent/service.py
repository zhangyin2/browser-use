...
class Agent:
	...
	def _log_response(self, response: AgentOutput) -> None:
		...
		logger.info(f'🔍 Todo subtasks: {response.current_state.todo_subtasks}')
		logger.info(f'🔍 Completed subtask: {response.current_state.completed_subtask}')
		logger.info(f'🔍 Confidence: {response.current_state.confidence}')
